...
def parse_args():
    ...
    parser.add_argument('--data_path', type=str, default='F:/HXY/SA3D/VAE_UNET/dataset/ALL/train/', help='dataset_name')
    parser.add_argument('--mode', type=str, default='front_to_leftside', help='mode of image translation')
    parser.add_argument('--test_data_path', type=str, default='F:/HXY/SA3D/VAE_UNET/dataset/ALL/test/rightside/', help='test dataset_name')
    ...
    parser.add_argument('--max_iter', type=int, default=60000, help='The number of iters')
    parser.add_argument('--continue_train', type=bool, default=False, help='continue train')
    parser.add_argument('--pretrained_model_path', type=str, default='./checkpoint/VAE_10000.ckpt', help='pretrained model path')
